	...
	useEffect(() => {
		const fetchServices = async () => {
			try {
				...
				const servicesData: serviceProps[] = response.data;
				...
				console.log(serviceDisplayBanners);
				...
				try {
					...
					const servicesData = data.filter(
						(service: { type: string }) => service.type === "General"
					);
	...
	return (
		<div className="custom-bg-4 min-vh-100">
			<div className="container d-flex flex-column px-3 px-md-4">
				...
				<div className="text-end bg-white shadow rounded-5 px-0 px-md-4 px-lg-5 py-5 mb-5">
					<div
