			...
			<div className="container py-5">
				<div className="bg-white border border-2 shadow text-end rounded-5 p-3 mb-4">
					...
					<div
						...
						style={{ direction: "rtl" }}
					>
						<div className="col mb-2 px-5" style={{ direction: "ltr" }}>
							<h5 className=" me-1">نام سرویس</h5>
							<div className="border border-1 border-primary shadow-sm rounded-4 pe-3 py-1">
								{service.name}
							</div>
						</div>
						<div className="col mb-2 px-5" style={{ direction: "ltr" }}>
				...
				<div className="bg-white border border-2 shadow text-end rounded-5 p-5 mb-4">
					...
					<div className="border border-1 border-primary shadow-sm rounded-4 px-3 mx-4 py-2"></div>
				</div>
				<div className="bg-white border border-2 shadow text-end rounded-5 p-5 mb-4">
